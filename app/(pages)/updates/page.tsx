...
export default async function UpdatesPage() {
	...
	return (
		<div className="w-full max-w-3xl mb-8 border-2 rounded-2xl border-cream-edge/25 bg-zinc-950/75">
			<div className="flex flex-col justify-center w-full p-2 divide-y divide-cream-edge/15" aria-label="Podcast Updates">
				{posts.map(post => {
